...
class EmployeeReviewTest < Minitest::Test
  ...
  def test_can_add_employee_to_department
    ...
    employee_one = Employee.create(name: "John Doe", email: "johndoe@johndoe.c", number: 1234567891, salary: 10000)
...
#     employee = Employee.create(name: "John Doe", email: "johndoe@johndoe.com",
